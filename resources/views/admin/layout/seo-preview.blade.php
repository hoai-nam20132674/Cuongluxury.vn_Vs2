<div class="widget-body">
    ...
    <div class="seo-edit-section">
        ...
        <div class="form-group">
            ...
            <input class="form-control" onchange="seo_preview()" id="seo_title" value="{{old('title')}}" style="text-transform: capitalize;" placeholder="Tiêu đề trang" data-counter="120" name="title" type="text" >
        </div>
        <div class="form-group ">
