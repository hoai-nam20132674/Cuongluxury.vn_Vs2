			                    ...
			                    <form method="POST" action="{{URL::route('postEditUser',$user->id)}}" accept-charset="UTF-8" id="profile-form" class="row"> 
			                    	<div class="col-md-9" style="display: flex; flex-wrap: wrap;">
				                        ...
				                        <div class="form-group col-md-12"  >
										    ...
										    <input class="form-control" data-counter="191" name="name" type="text" value="{{$user->name}}" id="name">
								        </div>
				                        <div class="form-group col-md-6"  >
				    
										    <label for="phone" class="control-label required">Điện thoại</label>
										    <input class="form-control" data-counter="10" name="phone" type="number" value="{{$user->phone}}" id="phone">
								        </div>
				    
				                        <div class="form-group col-md-6">
				    
										    <label for="email" class="control-label">Email</label>
										    <input disabled class="form-control" placeholder="Ex: example@gmail.com" data-counter="60" name="email" type="text" value="{{$user->email}}" id="email">
								        </div>
				                        <div class="clearfix"></div>
							        			...
							        			<div class="ui-select-wrapper">
							        				...
							        				<select class="form-control ui-select ui-select" id="role" name="role">
												    	@if($user->role == 1)
												            ...
												            <option value="0">Cộng tác viên viên</option>
												        @else
												        	<option value="1">Quản trị viên</option>
												            <option selected value="0">Cộng tác viên viên</option>
											            @endif
											        </select>
