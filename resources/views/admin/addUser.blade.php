                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group col-md-12"  >
                                        ...
                                        <input class="form-control" placeholder="Nhập họ tên" data-counter="191" name="name" type="text" value="" required id="name">
                                    </div>
                                    <div class="form-group col-md-6"  >
            
                                        <label for="phone" class="control-label required">Số điện thoại</label>
                                        <input class="form-control" placeholder="Nhập số điện thoại" data-counter="10" name="phone" type="number" required id="phone">
                                    </div>
                                    <div class="form-group col-md-6"  >
            
                                        <label for="email" class="control-label required">Email</label>
                                        <input class="form-control" placeholder="email" data-counter="190" name="email" type="email" required id="email">
                                    </div>
                                    <div class="form-group col-md-6"  >
            
                                        <label for="password" class="control-label required">M&acirc;̣t kh&acirc;̉u</label>
                                        <input class="form-control" placeholder="Nhập mật khẩu" data-counter="60" required name="password" type="password" id="password">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6"  >
                                        ...
                                        <input class="form-control" placeholder="Nhập lại mật khẩu" data-counter="60" required name="confirm_password" type="password" id="confirm_password">
                                    </div>
                                </div>
