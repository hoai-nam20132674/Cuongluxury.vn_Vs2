		                ...
		                <div class="caption">
		                    <div class="wrapper-action">
                            	...
                            	<div class="btn-group">
                                	...
                                	<ul class="dropdown-menu">
                                		<li>
                                            <a href="{{URL::route('adss')}}" class="" data-class-item="">Tất cả</a>
                                        </li>
		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="{{URL::route('addAds')}}"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
											...
											@endif
													<td class=" text-left no-sort">
														<div class="text-left">
														    <div class="checkbox checkbox-primary table-checkbox">
														        <input type="checkbox" class="checkboxes" name="id[]" value="{{$ads->id}}">
														    </div>
														</div>
													</td>
													...
													<td class=" text-center">
														<div class="table-actions">
										                    ...
										                    <a href="{{URL::route('editAds',$ads->id)}}" class="btn btn-icon btn-sm btn-primary" data-toggle="tooltip" data-original-title="Sửa">
										                    	<i class="fa fa-edit"></i>
										                    </a>
										        
										                    <a href="#" class="btn btn-icon btn-sm btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteAds',$ads->id)}}" role="button" data-original-title="Xóa bản ghi">
