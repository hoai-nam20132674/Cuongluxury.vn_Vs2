            ...
            <div class="theme-option-main">
                <div class="tab-content tab-content-in-right">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" placeholder="mã số thuế" data-counter="30" name="mst" type="text" value="{{$system->mst}}" id="mst">
                                                                    </div>
                                <hr>
                                                            <div class="form-group ">
                                ...
                                <hr>
                                    ...
                                    <input class="form-control" placeholder="website" data-counter="120" name="website" type="text" value="{{$system->website}}" id="website">
                                                                    ...
                                                                    <div class="form-group ">
                                    <label for="website" class="control-label">Script head</label>
                                    <textarea class="form-control" rows="6" placeholder="Nội dung" data-counter="10000" name="script" cols="50" id="content">{{$system->script}}</textarea>
                                    
                                                                    </div>
                                                                    <div class="form-group ">
                                    <label for="website" class="control-label">Script body</label>
                                    <textarea class="form-control" rows="6" placeholder="Nội dung" data-counter="10000" name="script_body" cols="50" id="content">{{$system->script_body}}</textarea>
                                ...
                                <hr>
                                    ...
                                    <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group ">
                                                    <label for="banner" class="control-label">Og:image</label>
                                                    <div class="image-box">
                                                        <div class="file-upload">   
                                                            <div class="file-upload-content file-upload-content103" style="position: relative;">   
                                                                @if($system->ogimage == '')
                                                                    <img width="100%" class="file-upload-image file-upload-image103" src="{{asset('uploads/images/icon-image.gif')}}" alt="your image" />
                                                                @else
                                                                    <img width="100%" class="file-upload-image file-upload-image103" src="{{asset('uploads/images/ogimage/'.$system->ogimage)}}" alt="your image" />
                                                                @endif
                                                                <div class="image-title-wrap image-title-wrap103" style="position: absolute;top: 0px; right: 0px;">
                                                                    <button type="button" onclick="removeUploadTest(103)" class="remove-image">Og:image</button>
                                                                </div>
                                                                <input style="z-index: 100; position: absolute; top: 0px; left: 0px;" class="file-upload-input file-upload-input103" type='file' name="ogimage" onchange="readURLTest(this,103);" accept="image/*" />
                                                            </div>
                                                        </div>
                                ...
                                <hr>
                                    ...
                                    <input class="form-control" name="youtube" type="text" value="{{$system->youtube}}" id="youtube">
                                                                    ...
                                                                    <hr>
                                                                    <div class="form-group ">
                                    <label for="blog_naver" class="control-label">Blog-naver</label>
                                    <input class="form-control" name="blog_naver" type="text" value="{{$system->blog_naver}}" id="blog_naver">
                                                                    </div>
                                <hr>
                                                    </div>
