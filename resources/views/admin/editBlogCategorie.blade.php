...
@section('content')
	<div class="page-content ">
                    ...
                    <div id="main">
                        <form method="POST" action="{{URL::route('postEditBlogCategorie',$cate->id)}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                            <input type="hidden" name="_token" value="{{ csrf_token()}}">
                            <div class="note note-success">
                                
                                @php
                                    if($cate->lang != 'vi'){
                                        $blog_cate_lang = App\BlogCategorieLang::where('blog_cate_lang_id',$cate->id)->where('lang',$cate->lang)->get()->first();
                                        $blog_cate = App\BlogCate::where('id',$blog_cate_lang->blog_cate_id)->first();
                                    }
                                @endphp
                                @if($cate->lang == 'vi')
                                    <p>Bạn đang sửa bản dịch "<strong class="current_language_text">Tiếng Việt</strong>" cho danh mục tin <a href="#">{{$cate->name}}</a></p>
                                @elseif($cate->lang == 'en')
                                    <p>Bạn đang sửa bản dịch "<strong class="current_language_text">English</strong>" cho danh mục tin <a href="#">{{$blog_cate->name}}</a></p>
                                @elseif($cate->lang == 'ko')
                                    <p>Bạn đang sửa bản dịch "<strong class="current_language_text">Korean</strong>" cho danh mục tin <a href="#">{{$blog_cate->name}}</a></p>
                                @elseif($cate->lang == 'ja')
                                    <p>Bạn đang sửa bản dịch "<strong class="current_language_text">Japan</strong>" cho danh mục tin <a href="#">{{$blog_cate->name}}</a></p>
                                @endif
                            ...
                            <div class="ui-select-wrapper">
                                <select class="select-search-full ui-select ui-select" id="parent_id" name="parent_id">
                                    ...
                                    @foreach($categories as $cates)
                                        ...
                                        @php
                                            $cate_childrens = App\BlogCate::where('parent_id',$cates->id)->get();
                                        @endphp
                                    ...
                                    @if($cate->lang == 'vi')
                                        ...
                                        <div id="list-others-language">
                                            @if(isset($ko))
                                                ...
                                                <a href="{{URL::route('editBlogCategorie',$ko->blog_cate_lang_id)}}" class="tip" title="Sửa bản dịch">Korean <i class="fa fa-edit"></i></a>
                                            @else
                                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Flag_of_South_Korea.svg/225px-Flag_of_South_Korea.svg.png" title="Korean" width="16" alt="Korean">
                                                <a href="{{URL::route('addBlogCategorie')}}?blog_cate_id={{$cate->id}}&lang=ko" class="tip" title="Tạo bản dịch">Korean <i class="fa fa-plus"></i></a>
                                            @endif
                                            <br>
                                            @if(isset($en))
                                                <img src="https://cms.botble.com/vendor/core/core/base/images/flags/us.svg" title="English" width="16" alt="English">
                                                
                                                <a href="{{URL::route('editBlogCategorie',$en->blog_cate_lang_id)}}" class="tip" title="Sửa bản dịch">English <i class="fa fa-edit"></i></a>
                                            @else
                                                <img src="https://cms.botble.com/vendor/core/core/base/images/flags/us.svg" title="English" width="16" alt="English">
                                                <a href="{{URL::route('addBlogCategorie')}}?blog_cate_id={{$cate->id}}&lang=en" class="tip" title="Tạo bản dịch">English <i class="fa fa-plus"></i></a>
                                            @endif
                                            <br>
                                            @if(isset($ja))
                                                ...
                                                <a href="{{URL::route('editBlogCategorie',$ja->blog_cate_lang_id)}}" class="tip" title="Sửa bản dịch">Japan <i class="fa fa-edit"></i></a>
                                            @else
                                                <img style="border: 1px solid #ececec;" src="https://upload.wikimedia.org/wikipedia/commons/9/9e/Flag_of_Japan.svg" title="Japan" width="16" alt="Japan">
                                                <a href="{{URL::route('addBlogCategorie')}}?blog_cate_id={{$cate->id}}&lang=ja" class="tip" title="Tạo bản dịch">Japan <i class="fa fa-plus"></i></a>
                                            @endif
                                        </div>
                                    @else
                                        @php
                                            $blog_cate_lang = App\BlogCategorieLang::where('blog_cate_lang_id',$cate->id)->get()->first();
                                            $cate_vi = App\BlogCate::where('id',$blog_cate_lang->blog_cate_id)->with('langs')->get()->first();
                                        ...
                                        <div id="list-others-language">
                                            <img src="https://cms.botble.com/vendor/core/core/base/images/flags/vn.svg" title="Tiếng Việt" width="16" alt="Tiếng Việt">
                                            <a href="{{URL::route('editBlogCategorie',$cate_vi->id)}}" title="Sửa bản dịch Việt Nam"> Tiếng Việt <i class="fa fa-edit"></i></a>
                                            <br>
                                            @if(isset($ko))
                                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Flag_of_South_Korea.svg/225px-Flag_of_South_Korea.svg.png" title="Korean" width="16" alt="Korean">
                                            ...
                                            @else
                                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Flag_of_South_Korea.svg/225px-Flag_of_South_Korea.svg.png" title="Korean" width="16" alt="Korean">
                                                <a href="{{URL::route('addBlogCategorie')}}?blog_cate_id={{$cate_vi->id}}&lang=ko" class="tip" title="Tạo bản dịch">Korean <i class="fa fa-plus"></i></a>
                                            @endif
                                            <br>
                                            @if(isset($en))
                                                <img src="https://cms.botble.com/vendor/core/core/base/images/flags/us.svg" title="English" width="16" alt="English">
                                            ...
                                            @else
                                                <img src="https://cms.botble.com/vendor/core/core/base/images/flags/us.svg" title="English" width="16" alt="English">
                                                <a href="{{URL::route('addBlogCategorie')}}?blog_cate_id={{$cate_vi->id}}&lang=en" class="tip" title="Tạo bản dịch">English <i class="fa fa-plus"></i></a>
                                            @endif
                                            <br>
                                            @if(isset($ja))
                                                <img style="border: 1px solid #ececec;" src="https://upload.wikimedia.org/wikipedia/commons/9/9e/Flag_of_Japan.svg" title="Japan" width="16" alt="Japan">
                                            ...
                                            @else
                                                <img style="border: 1px solid #ececec;" src="https://upload.wikimedia.org/wikipedia/commons/9/9e/Flag_of_Japan.svg" title="Japan" width="16" alt="Japan">
                                                <a href="{{URL::route('addBlogCategorie')}}?blog_cate_id={{$cate_vi->id}}&lang=ja" class="tip" title="Tạo bản dịch">Japan <i class="fa fa-plus"></i></a>
                                            @endif
                                        </div>
                                    @endif
                            ...
                            <div class="image-box" style="border: 1px solid #e2e2e2;">
                                <div class="file-upload">   
                                    <div class="file-upload-content file-upload-content100" style="position: relative;">
                                        <img width="100%" class="file-upload-image file-upload-image100" src="{{asset('uploads/images/blogs/categories/'.$cate->avata)}}" alt="your image" />
