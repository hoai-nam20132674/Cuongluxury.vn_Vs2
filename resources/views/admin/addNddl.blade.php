...
@section('content')
	<div class="page-content ">
                    <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Thêm nội dung độc lập mới</li>
                    ...
                    <div id="main">
                        <form method="POST" action="{{URL::route('postAddNddl')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                ...
                <div class="main-form">
                    <div class="form-body">
                        <div class="form-group"  >
                            ...
                            <input class="form-control" placeholder="Nhập tiêu đề" data-counter="190" name="name" value="{{old('name')}}" type="text" required id="name">
                        </div>
                        <div class="form-group"  >
    
                            <label for="keyword" class="control-label required">Keyword</label>
                            <input class="form-control" placeholder="Nhập từ khóa" data-counter="190" name="keyword" value="{{old('keyword')}}" type="text" required id="keyword">
                        </div>
                        ...
                        <div class="form-group"  >
                            ...
                            <textarea class="form-control" rows="4" placeholder="Nội dung" name="content" cols="50" id="content">{{old('content')}}</textarea>
