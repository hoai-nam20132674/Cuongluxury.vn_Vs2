...
@section('content')
	<div class="page-content ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Danh mục video</li>
		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="{{URL::route('addVideoCategorie')}}"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
                            			...
                            			@foreach($categories as $cate)
                            				...
                            				<tr role="row" class="odd">
												...
												<td class=" text-center">
													<a href="{{URL::route('editVideoCategorie',$cate->id)}}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="Sửa"><i class="fa fa-edit"></i></a>
													<a href="#" class="btn btn-icon btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteVideoCategorie',$cate->id)}}" role="button" data-original-title="Xóa bản ghi"><i class="fa fa-trash"></i></a>
												</td>
											</tr>
											@php
                                            ...
                                            @foreach($cate_childrens as $cate_children)
                                            	<tr role="row" class="odd">
													...
													<td class=" text-left column-key-name"><a href="{{URL::route('editVideoCategorie',$cate_children->id)}}">{{$cate_children->name}}</a></td>
													<td class="  column-key-created_at">{{$cate_children->created_at}}</td>
													<td class="  column-key-updated_at">{{$cate_children->updated_at}}</td>
													@if($cate_children->status ==1)
														<td class="  column-key-status"><span class="label-success status-label">Xuất bản</span></td>
													@else
														<td class="  column-key-status"><span class="label-danger status-label">Bản nháp</span></td>
													@endif
													...
													<td class=" text-center">
														<a href="{{URL::route('editVideoCategorie',$cate_children->id)}}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="Sửa"><i class="fa fa-edit"></i></a>
														<a href="#" class="btn btn-icon btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteVideoCategorie',$cate_children->id)}}" role="button" data-original-title="Xóa bản ghi"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
                                            @endforeach
											@php
