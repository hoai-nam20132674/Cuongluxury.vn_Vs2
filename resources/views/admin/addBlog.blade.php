...
@section('content')
	<div class="page-content ">
                    ...
                    <div id="main">
                        <form method="POST" action="{{URL::route('postAddBlog')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                            @if(isset($request->blog_id))
                            <div class="note note-success">
                                @php
                        
                                    $bg = App\Blog::where('id',$request->blog_id)->get()->first();
                                    
                                @endphp
                                @if($request->lang == 'vi')
                                    <p>Bạn đang thêm bản dịch "<strong class="current_language_text">Tiếng Việt</strong>" cho bài viết <a href="#">{{$bg->name}}</a></p>
                                @elseif($request->lang == 'en')
                                    <p>Bạn đang thêm bản dịch "<strong class="current_language_text">English</strong>" cho bài viết <a href="#">{{$bg->name}}</a></p>
                                @elseif($request->lang == 'ko')
                                    <p>Bạn đang thêm bản dịch "<strong class="current_language_text">Korean</strong>" cho bài viết <a href="#">{{$bg->name}}</a></p>
                                @elseif($request->lang == 'ja')
                                    <p>Bạn đang thêm bản dịch "<strong class="current_language_text">Japan</strong>" cho bài viết <a href="#">{{$bg->name}}</a></p>
                                @endif
                ...
                <div class="main-form">
                    <div class="form-body">
                        ...
                        <div class="form-group"  >
                            ...
                            <textarea class="form-control" rows="4" placeholder="Nội dung" data-counter="400" name="content" cols="50" id="content">{{old('url')}}</textarea>
...
<div class="form-actions form-actions-fixed-top hidden">
    ...
    <svg class="svg-next-icon svg-next-icon-size-16">
        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                    ...
                    <input class="hidden" type="number" name="blog_id" value="{{$request->blog_id}}">
                    <div class="widget meta-boxes">
                            <div class="widget-title">
