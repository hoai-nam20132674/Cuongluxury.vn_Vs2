...
<div class="page-content ">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item"><a href="{{URL::route('popups')}}">Danh sách popup</a></li>
		<li class="breadcrumb-item active">Chỉnh sửa popup</li>
	</ol>
	...
	<div id="main">
		@if( Session::has('flash_message'))
	    	...
	    	@endif
		<form method="POST" action="{{URL::route('postEditPopup',$popup->id)}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
							...
							<div class="image-box" style="border: 1px solid #e2e2e2;">
								<div class="file-upload">   
									<div class="file-upload-content file-upload-content100" style="position: relative;">
										<img width="100%" class="file-upload-image file-upload-image100" src="{{asset('uploads/images/popups/'.$popup->url)}}" alt="your image" />
							...
							<div class="main-form" style="margin-bottom: 0px">
								<div class="form-body">
									<div class="form-group" style="margin-bottom: 0px" >
										<input class="form-control" placeholder="Link trang đích" value="{{$popup->href}}" name="href" type="text" id="href">
									</div>
