                ...
                <div class="main-form">
                    <div class="form-body">
                        ...
                        <div class="form-group"  >
                            ...
                            <input class="form-control" placeholder="Nhập link video" data-counter="120" name="href" value="{{old('href')}}" type="text" required id="href">
                        </div>

                        <div class="form-group">
                            <label for="content" class="control-label">Mô tả</label>
                            <textarea class="form-control" rows="4" placeholder="Mô tả ngắn" data-counter="400" name="content" cols="50" id="content">{{old('content')}}</textarea>
                        </div>
