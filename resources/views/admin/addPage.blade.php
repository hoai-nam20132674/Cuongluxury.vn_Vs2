...
@section('content')
	<div class="page-content ">
                    <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Thêm trang mới</li>
                    ...
                    <div id="main">
                        <form method="POST" action="{{URL::route('postAddPage')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
...
<div class="form-actions form-actions-fixed-top hidden">
            <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{URL::route('blogs')}}">Trang</a></li>
