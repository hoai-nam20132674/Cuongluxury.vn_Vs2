												...
												<td class=" text-center language-header no-sort">
													<div class="text-center language-column">
														...
														@if(count($cate->langs) == 0)
															<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate->id}}&lang=ko" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
															<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate->id}}&lang=en" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
															<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate->id}}&lang=ja" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
														@else
															@php
															...
															@endphp
															@if(isset($ko))
																<a href="{{URL::route('editProductCategorie',$ko->product_cate_lang_id)}}" class="tip" title="Sửa bản dịch"><i class="fa fa-edit"></i></a>
															@else
																<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate->id}}&lang=ko" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
															@endif
															@if(isset($en))
																<a href="{{URL::route('editProductCategorie',$en->product_cate_lang_id)}}" class="tip" title="Sửa bản dịch"><i class="fa fa-edit"></i></a>
															@else
																<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate->id}}&lang=en" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
															@endif
															@if(isset($ja))
																<a href="{{URL::route('editProductCategorie',$ja->product_cate_lang_id)}}" class="tip" title="Sửa bản dịch"><i class="fa fa-edit"></i></a>
															@else
																<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate->id}}&lang=ja" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
															@endif
													...
													<td class=" text-center language-header no-sort">
														<div class="text-center language-column">
															...
															@if(count($cate_children->langs) == 0)
																<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate_children->id}}&lang=ko" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
																<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate_children->id}}&lang=en" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
																<a href="{{URL::route('addProductCategorie')}}?product_cate_id={{$cate_children->id}}&lang=ja" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
															@else
																@php
