...
@section('content')
	<div class="page-content ">
                    <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{URL::route('nddls')}}">Nội dung độc lập</a></li>
            
        
                            <li class="breadcrumb-item active">Sửa nội dung độc lập</li>
                    ...
                    <div id="main">
                        <form method="POST" action="{{URL::route('postEditNddl',$nddl->id)}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                ...
                <div class="main-form">
                    <div class="form-body">
                        <div class="form-group"  >
                            ...
                            <input class="form-control" placeholder="Nhập tên phương thức" data-counter="120" name="name" type="text" value="{{$nddl->name}}" required id="name">
                        </div>
                        <div class="form-group"  >
    
                            <label for="keyword" class="control-label required">Keyword</label>
                            <input class="form-control" placeholder="Nhập keyword" data-counter="120" name="keyword" type="text" value="{{$nddl->keyword}}" required id="keyword">
                        </div>
                        ...
                        <div class="form-group"  >
                            ...
                            <textarea class="form-control" rows="4" placeholder="Nội dung" name="content" cols="50" id="content">{{$nddl->content}}</textarea>
