		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="{{URL::route('addProperties')}}"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
                            	...
                            	<table class="table table-striped table-hover vertical-middle dataTable no-footer" id="table-categories" role="grid" aria-describedby="table-categories_info" style="width: 1582px;">
                            		<thead>
										<tr>
											...
											<th  title="Thuộc tính" width="300px" class=" column-key-image">Thuộc tính</th>
											<th  title="Giá trị" class="properties-value">Giá trị</th>
											...
											@endif
													...
													<td class="column-key-id">
														@foreach($values as $val)
															<span class="label-success status-label">{{$val->value}}</span>
														@endforeach
													</td>
													...
													<td class=" text-center">
														<div class="table-actions">
										                    ...
										                    <a href="{{URL::route('editProperties',$item->id)}}" class="btn btn-icon btn-sm btn-primary" data-toggle="tooltip" data-original-title="Sửa">
										                    	<i class="fa fa-edit"></i>
										                    </a>
										        
										                    <a href="#" class="btn btn-icon btn-sm btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteContact',$item->id)}}" role="button" data-original-title="Xóa bản ghi">
