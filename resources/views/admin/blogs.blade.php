											...
											@endif
													...
													<td class=" text-center language-header no-sort">
														<div class="text-center language-column">
															...
															@if(count($blog->langs) == 0)
																<a href="{{URL::route('addBlog')}}?blog_id={{$blog->id}}&lang=ko" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
																<a href="{{URL::route('addBlog')}}?blog_id={{$blog->id}}&lang=en" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
																<a href="{{URL::route('addBlog')}}?blog_id={{$blog->id}}&lang=ja" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
															@else
																@php
																...
																@endphp
																@if(isset($ko))
																	<a href="{{URL::route('editBlog',$ko->blog_lang_id)}}" class="tip" title="Sửa bản dịch"><i class="fa fa-edit"></i></a>
																@else
																	<a href="{{URL::route('addBlog')}}?blog_id={{$blog->id}}&lang=ko" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
																@endif
																@if(isset($en))
																	<a href="{{URL::route('editBlog',$en->blog_lang_id)}}" class="tip" title="Sửa bản dịch"><i class="fa fa-edit"></i></a>
																@else
																	<a href="{{URL::route('addBlog')}}?blog_id={{$blog->id}}&lang=en" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
																@endif
																@if(isset($ja))
																	<a href="{{URL::route('editBlog',$ja->blog_lang_id)}}" class="tip" title="Sửa bản dịch"><i class="fa fa-edit"></i></a>
																@else
																	<a href="{{URL::route('addBlog')}}?blog_id={{$blog->id}}&lang=ja" class="tip" title="Tạo bản dịch"><i class="fa fa-plus"></i></a>
																@endif
															@endif
