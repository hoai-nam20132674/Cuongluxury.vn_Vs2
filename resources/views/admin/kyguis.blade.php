...
<div class="page-content ">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ký gửi BĐS</li>
                        ...
                        <div class="wrapper-action">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="#" data-href="{{URL::route('deleteKyguis')}}" class="deletes" data-class-item="">Xoá</a>
                                    </li>
                                 </ul>
                            </div>
                            <div class="btn-group">
                    ...
                    <div class="table-responsive  table-has-actions   table-has-filter ">
                        <div id="table-users_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            <div id="table-users_filter" class="dataTables_filter">
                                <label><input type="search" url="{{URL::route('kyguis')}}" name="keyword" onchange="searchKygui()" class="form-control form-control-sm" placeholder="Tìm kiếm..." aria-controls="table-users"></label>
                            </div>
                            ...
                            <table class="table table-striped table-hover vertical-middle dataTable no-footer" id="table-users" role="grid" aria-describedby="table-users_info" style="width: 1582px;">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th title="Loại ký gửi" class="text-left column-key-email sorting" tabindex="0" aria-controls="table-users" rowspan="1" colspan="1" aria-label="Emailorderby asc">Loại ký gửi</th>
                                        ...
                                        <th title="Giá" class="text-left column-key-email sorting" tabindex="0" aria-controls="table-users" rowspan="1" colspan="1" aria-label="Emailorderby asc">Trạng thái</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($kyguis as $item)
                                        ...
                                        @endif
                                            ...
                                            <td class=" text-left column-key-email">{{$item->lkg}}</td>
                                            ...
                                            <td class=" text-right">
                                                ...
                                                <a href="{{URL::route('kygui',$item->id)}}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="Xem chi tiết"><i class="fa fa-eye"></i></a>
                                                <a href="#" class="btn btn-icon btn-sm btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteKygui',$item->id)}}" role="button" data-original-title="Xóa bản ghi">
