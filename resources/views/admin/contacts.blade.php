		                    ...
		                    <div class="wrapper-action">
                                <div class="btn-group">
                                	...
                                	<ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="#" data-href="{{URL::route('deleteContacts')}}" class="deletes" data-class-item="">Xoá</a>
                                        </li>
                                    </ul>
                            	</div>
		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="#"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
                            	...
                            	<table class="table table-striped table-hover vertical-middle dataTable no-footer" id="table-categories" role="grid" aria-describedby="table-categories_info" style="width: 1582px;">
                            		<thead>
										<tr>
											...
											<th  title="Họ tên" width="300px" class=" column-key-image">Họ tên</th>
											<th  title="Số điện thoại" class="text-left column-key-name">Số điện thoại</th>
											<th  title="Email" width="300px" class="no-sort column-key-updated_at">Email</th>
											<th  title="Lời nhắn" width="300px" class="no-sort column-key-updated_at">Yêu cầu</th>
											<th  title="Ngày tạo" width="200px" class=" column-key-created_at">Ngày tạo</th>
											<!-- <th  title="Trạng thái" width="300px" class=" column-key-status">Trạng thái</th> -->
									...
									<tbody>
										...
										@foreach($contacts as $contact)
											...
											@endif
													<td class=" text-left no-sort">
														<div class="text-left">
														    <div class="checkbox checkbox-primary table-checkbox">
														        <input type="checkbox" class="checkboxes" name="id[]" value="{{$contact->id}}">
														    </div>
														</div>
													</td>
													<td class="column-key-id sorting_{{$i}}">{{$i}}</td>
													<td class="  column-key-image" style="text-align: left;">
														{{$contact->name}}
													</td>
													...
													<td class=" no-sort column-key-updated_at" style="text-align: left;">
														{{$contact->email}}
													</td>
													
													<td class="  column-key-created_at" style="text-align: left;">{{$contact->message}}</td>
													<td class="  column-key-created_at">{{$contact->created_at}}</td>
													
													<!-- <td class="  column-key-status">
														@if($contact->status ==0)
														<a style="margin: 0px; padding: 2px; background-color: #36c6d3;color: #fff;" class="btn btn-sm btn-default">Chưa xem</a>
														@else
														<a style="margin: 0px; padding: 2px; background-color: #dc3545;color: #fff;" class="btn btn-sm btn-default">Đã xem</a>
														@endif
													</td> -->
													...
													<td class=" text-center">
														<div class="table-actions">
										                    ...
										                    <a href="#" class="btn btn-icon btn-sm btn-primary" data-toggle="tooltip" data-original-title="Sửa">
										                    	<i class="fa fa-edit"></i>
										                    </a>
										        
										                    <a href="#" class="btn btn-icon btn-sm btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deleteContact',$contact->id)}}" role="button" data-original-title="Xóa bản ghi">
