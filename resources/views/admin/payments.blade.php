...
@section('content')
	<div class="page-content ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Dang sách phương thức thanh toán</li>
		                ...
		                <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="table-categories_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer" style="width: 100%;">
                            	...
                            	<div class="dt-buttons btn-group"> 
                            		<button class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories"><span><span data-action="create" data-href="{{URL::route('addPayment')}}"><i class="fa fa-plus"></i> Tạo mới</span></span></button> 
											...
											@endif
													<td class=" text-left no-sort">
														<div class="text-left">
														    <div class="checkbox checkbox-primary table-checkbox">
														        <input type="checkbox" class="checkboxes" name="id[]" value="{{$payment->id}}">
														    </div>
														</div>
													</td>
													<td class="column-key-id sorting_{{$i}}">{{$i++}}</td>
													
													<td class=" text-left column-key-name">{{$payment->title}}</td>
													<td class="  column-key-created_at">{{$payment->created_at}}</td>
													@if($payment->status ==1 )
													...
													<td class=" text-center">
														<div class="table-actions">
										                    ...
										                    <a href="{{URL::route('editPayment',$payment->id)}}" class="btn btn-icon btn-sm btn-primary" data-toggle="tooltip" data-original-title="Sửa">
										                    	<i class="fa fa-edit"></i>
										                    </a>
										        
										                    <a href="#" class="btn btn-icon btn-sm btn-danger deleteDialog delete" data-toggle="tooltip" data-section="{{URL::route('deletePayment',$payment->id)}}" role="button" data-original-title="Xóa bản ghi">
