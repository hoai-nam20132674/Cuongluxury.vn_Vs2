					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-12 pr-0 content-right">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#">Tất cả(0)</a></li>
								...
								<div id="home" class="tab-pane fade in active ">
									...
									<div id="group" order-id="{{$order->id}}" class="order-card__content-wrapper ng-scope" >
										<div id="top" class="order-content__header">
											@php
												$a = $orders_detail->where('orders_id',$order->id)->first();
												$product = App\Product::where('id',$a->products_id)->get()->first();
													...
													<div class="order-content__header__seller__name d-flex ng-scope" ng-controller="chatCtrl">
														<div class="visible-xs">
															<div class="d-flex" a="" title="Quà tặng toàn quốc" href="/qua-tang-toan-quoc-s32695">
																<div class="avatar">
																	<img src="{{asset('uploads/images/users/avatars/'.$s->avatar)}}" alt="">
																</div>

																<a href="/qua-tang-toan-quoc-s32695" target="_blank" class="shop-name visible-xs ng-binding">{{$s->name_s}}</a>
															</div>
														</div>
														<a href="#chat" ng-click="chat(package.merchant.id)" class="btn btn-primary visible-xs button-chat">
															<i class="far fa-comment-dots mr-1"></i>Chat
														</a>
											...
											<div class="purchase-card-left d-flex p-relative">
												<div class="shop-info">
													...
													<div class="order-content__header__seller__name d-flex ng-scope" style="margin: 0 10px" ng-controller="chatCtrl">
														<a title="Quà tặng toàn quốc" href="/qua-tang-toan-quoc-s32695" target="_blank" class="shop-name ng-binding">{{$s->name_s}}</a>
