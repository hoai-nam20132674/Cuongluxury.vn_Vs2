		...
		<div class="container contaiver-v2">
			<nav class="b__breadcrumb--seller" aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Đơn hàng đã bán</li>
				</ol>
			</nav>
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-12 pr-0 content-right">
							<ul class="nav nav-tabs" role="tablist">
								<li class="nav-item active"><a data-toggle="tab" href="#tat-ca">Tất cả({{count($orders)}})</a></li>
								<li class="nav-item"><a data-toggle="tab" href="#cho-duyet">Chờ duyệt()</a></li>
								
								<li class="nav-item"><a data-toggle="tab" href="#da-duyet">Đã duyệt()</a></li>
							</ul>
							<div class="tab-content responsive-hide">
								<div id="tat-ca" class="tab-pane fade in active ">
													...
													@if($order->status ==0)
														<div class="badge1 badge badge-pill pack-status visible-xs ng-binding badge-danger" style="padding: 3px;">
															<div class="form-group" style="margin-bottom: 0px;">
						                                        <select class="form-control ui-select ui-select" onchange="confirmOrder('{{URL::route('merchantConfirmOrder',$order->id)}}')" name="" id="">
						                                        	<option value="0">Chờ duyệt</option>
						                                        	<option value="1">Đã duyệt đơn</option>
														...
														<div class="cart-info col-md-5 col-sm-8 p-0">
															<a href="#">
																<div class="image-wrapper">
																	<img style="height: 65px" src="{{asset('uploads/images/products/details/'.$product->avata)}}">
								...
								<div id="cho-duyet" class="tab-pane fade in">
									<!-- <div class="form-group search-bar">
										<input type="text" ng-model="code" ng-change="search();" class="form-control" placeholder="Tìm kiếm theo mã đơn hàng, mã bưu gửi">
									</div> -->
									<div class="order-content__header table-header border-bottom" style="padding: 8px 0px 0 7px; font-size: 13px;height: 35px;">
								...
								<div id="da-duyet" class="tab-pane fade in">
									<!-- <div class="form-group search-bar">
										<input type="text" ng-model="code" ng-change="search();" class="form-control" placeholder="Tìm kiếm theo mã đơn hàng, mã bưu gửi">
									</div> -->
									<div class="order-content__header table-header border-bottom" style="padding: 8px 0px 0 7px; font-size: 13px;height: 35px;">
	...
	<script type="text/javascript">
		function confirmOrder(i){
			$.ajax({
                ...
                success: function(data) {
                    if(data ==1 ){
                    	toastr.success('Xác thực đơn thành công');
                    	$('.main-popup[id="dhtc"]').removeClass('hidden');
                    }
                    else{
                    	toastr.warning('Xác thực đơn hàng không thành công');
                    }
                }
            });
   // console.log(i);
