...
@section('head')
	...
	<title>Tạo gian hàng đối tác</title>
	...
	<div class="container contaiver-v2">
		<nav class="b__breadcrumb--seller" aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Thêm mới gian hàng đối tác</li>
			</ol>
		</nav>
									...
									<div class="b__seller--box">
										<div class="b__title title_filter">
											<div class="form-row" style="padding-bottom: 10px">
												<div class="col-md-6 col-sm-12">
													<h3>Thêm mới gian hàng đối tác</h3>
												</div>
										...
										<div class="filter_form" >
											<div id="main" style="padding-left: 0px;">
									            <form method="POST" action="{{URL::route('merchantPostAddCTV')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
									                                	...
									                                	<div class="row">
									                            			<div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <input class="form-control" placeholder="Nhập họ tên" data-counter="120" maxlength="190" value="" required name="name" type="text" required id="name">
											                                    </div>
											                                ...
											                                <div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <input class="form-control" placeholder="Nhập mật khẩu" maxlength="190" data-counter="100" value="" name="password" type="password" required id="password">
											                                    </div>
											                            ...
											                            <div class="row" >
											                            	<div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <label for="phone" class="control-label required">Số điện thoại (Tên đăng nhập)</label>
											                                        <input class="form-control" placeholder="Nhập số điện thoại" maxlength="10" data-counter="10" value="" name="phone" max="2147483647" type="number" required id="phone">
											                                    </div>
											                                ...
											                                <div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <input class="form-control" placeholder="Nhập lại mật khẩu" maxlength="190" data-counter="100" value="" name="confirm_password" type="password" required id="confirm_password">
											                                    </div>
											                            ...
											                            <div class="row" >
											                            	<div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <input class="form-control" placeholder="Nhập đường dẫn facebook" maxlength="190" value="" name="fb" type="text" id="fb">
											                                    </div>
											                                ...
											                                <div class="col-md-6">
											                                    <div class="form-group"  >
											                                        ...
											                                        <input class="form-control" placeholder="Nhập địa chỉ" maxlength="190" value="" name="address" type="text" id="address">
											                                    </div>
									                ...
									                <div class="row">
									                	<div class="col-md-12">
									                		<div class="widget-body" >
								                                <div class="btn-set">
								                                    <button type="submit" name="submit" value="save" class="btn btn-danger" style="width: 100%; background: #03ab9a;">
